...
Boolean values are _true_ and _false_; same stupid truthiness concept as JavaScript means only _nil_ and _false_ are falsey, and this means that zero, the empty string, and empty core data structures are all _true_:
